...
<!-- app input contents form -->
          <div class="designInputFrom webDesignInput">
            <form action="/gold/php_process/pages/app_insert.php?num=<?=$app_num?>" method="post" name="app_form" enctype="multipart/form-data">
              ...
              <div class="uploadImgs clear">
                <div class="uploadBox appImg img1">
                  ...
                  <div class="img1_box imgWrap">
                    <img id="img1" src="/gold/data/app_main<?=$app_result_img1?>">
                  </div>
                </div>
                <div class="uploadBox appImg img2">
                  ...
                  <div class="img2_box imgWrap">
                    <img id="img2" src="/gold/data/app_thumb<?=$app_result_img2?>">
                  </div>
                </div>
              </div>
