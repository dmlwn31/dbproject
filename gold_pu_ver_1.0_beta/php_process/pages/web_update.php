...
$thumbnail_error = $_FILES['thumbnail']['error'];  
 ...
 $sql="update gold_web set
  ...
  GOLD_WEB_ser='$web_ser',
  GOLD_WEB_des='$web_des',
  GOLD_WEB_img='$web_img',
  GOLD_WEB_mimg='$web_mimg',
  GOLD_WEB_thumb='$web_thumb',
  GOLD_WEB_cli='$web_cli',
  GOLD_WEB_reg='$web_reg',
  GOLD_WEB_dom='$web_dom' where GOLD_WEB_num=$web_result_num";
